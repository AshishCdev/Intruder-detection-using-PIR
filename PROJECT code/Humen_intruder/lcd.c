...
char_str cus_chr [8]={
	{0,0,0,0x4,0x4,0,0,0},	//hex value for putting at the first location of CGRAM and so on
	{0,0xe,0xa,0xa,0xa,0xa,0xe,0},
	{0x1f,0x11,0x11,0x11,0x11,0x11,0x11,0x1f},
	{0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff},
	{0,0,0,0,0,0,0x10,0x10},
	{0,0,0,0,0x8,0x8,0x18,0x18},
	{0,0,0x4,0x4,0xc,0xc,0x1c,0x1c},
	{0x2,0x2,0x6,0x6,0xe,0xe,0x1e,0x1e},
};

void lcd_puti(int print_val){
	char buff[10];
	itoa(print_val,buff,10);
	lcd_puts(buff);
}

void lcd_putf(float print_val){
	char i;
	long int temp=print_val,temp1;
	int dec_plc=1;
	if (print_val<0)
	{
		lcd_putc('-');
