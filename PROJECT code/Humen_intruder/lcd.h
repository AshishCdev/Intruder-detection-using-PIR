...
/**
 ...
 @return   none
*/
/* functions for controlling back light with pwm*/
extern void lcd_bck_pwm(uint8_t duty);
extern void lcd_bck_on(void);
extern void lcd_bck_off(void);
extern void lcd_buf_ini(void);
extern void lcd_put_cus(unsigned char index);
extern void lcd_bck_spc(void);
extern void lcd_data(uint8_t data);
 

//prints integer values
extern void lcd_puti (int print_val);
